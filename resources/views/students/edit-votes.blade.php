...
@section('content')
  ...
  <form method="POST" action="{{ route('counselors.update', $id) }}">
    @csrf
...
<div class="fixed-bottom">
    <button type="submit"  style="font-size: 24px;" class="btn btn-primary float-right mr-lg-5 mb-lg-5">Submit Your Vote</button>
  </div>
